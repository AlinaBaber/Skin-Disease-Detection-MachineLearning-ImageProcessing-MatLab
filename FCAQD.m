...
% Last Modified by GUIDE v2.5 27-Apr-2022 11:23:09
...
set(handles.categorytxt,'string',Quality); 
...
image_file=handles.test_path_txt.String;
testimagesegmentation(image_file);
[similarity,meandice,stddice]=diceimagesegmentation(image_file);
set(handles.labeltxt,'string',similarity);
set(handles.dicemeantxt,'string',meandice);
set(handles.dicestdtxt,'string',stddice);
...
% --- Executes on button press in featurebtn.
function featurebtn_Callback(hObject, eventdata, handles)
% hObject    handle to featurebtn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
imagefilepath='ImgPIA.jpeg';
ImagePIAfeatures(imagefilepath)
